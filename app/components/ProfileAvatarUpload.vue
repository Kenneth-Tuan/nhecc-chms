...
<template>
  <section
    ...
    :class="{
      'p-8 bg-slate-50 dark:bg-surface-900/50 rounded-3xl border border-slate-100 dark:border-surface-700':
        !plain,
    }"
  >
    <FileUpload
    ...
    >
      <Avatar
        ...
        shape="circle"
        class="!w-32 !h-32 !text-4xl shadow-xl ring-4 ring-white dark:ring-surface-700 !bg-slate-100 dark:!bg-surface-800"
        :style="
      ...
      />
      <div
        class="absolute bottom-0 right-0 flex items-center justify-center w-10 h-10 bg-primary text-white shadow-md border-2 border-white dark:border-surface-900 rounded-full"
      >
        <i class="pi pi-camera text-base"></i>
      </div>
    </div>
    <div class="mt-4 text-center">
      <p class="font-bold text-slate-700 dark:text-surface-100">更新頭像</p>
