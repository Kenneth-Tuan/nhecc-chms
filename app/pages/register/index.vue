      ...
      >
        ...
        <Step v-slot="{ activateCallback, value }" asChild :value="2">
          <div
            ...
            :class="[
              Number(value) <= activeStep ? 'cursor-pointer' : 'cursor-default',
            ]"
          >
            <div
              :class="[
          ...
          <template v-if="!isSocialRegister">
            ...
            <div class="flex flex-col gap-2">
              ...
              <small
                ...
                >{{ errors1.confirmPassword || errors2.confirmPassword }}</small
              >
            </div>
          </template>
          ...
          <section class="space-y-4" v-if="false">
            ...
            <div class="flex flex-col gap-2">
              ...
              <small
                ...
                >{{ errors1.previousCourses || errors2.previousCourses }}</small
              >
            </div>
          </section>
