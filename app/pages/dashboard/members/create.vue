...
const { isSubmitting, fieldErrors, clearFieldError, validateCreate, submitCreate } = useMemberForm();
const { avatarPreview, avatarFile, isUploading, avatarError, onAvatarSelect, uploadAvatar, removeAvatar } = useAvatarUpload();
...
// Mobile blur handler with debounce
...
async function handleSubmit(): Promise<void> {
  ...
  // Check mobile uniqueness before submitting
  ...
  <div class="max-w-4xl">
    ...
    <div class="flex items-center gap-3 mb-6">
      ...
      <div>
        ...
        <p class="text-sm text-slate-500 mt-1">填寫會友基本資料</p>
      </div>
    </div>
        ...
        <div class="mb-6">
          ...
          <div class="flex items-center gap-4">
            <Avatar
              ...
              :label="!avatarPreview ? (form.fullName?.charAt(0) || '?') : undefined"
              shape="circle"
