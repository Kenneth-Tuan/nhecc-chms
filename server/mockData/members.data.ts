...
export const mockMembers: Member[] = [
  ...
  m({
    ...
    emergencyContactPhone: '0933-445-566',
    baptismStatus: true,
  ...
  m({
    ...
    emergencyContactPhone: '0944-556-677',
    baptismStatus: true,
  ...
  m({
    ...
    emergencyContactRelationship: '配偶',
    emergencyContactPhone: '0966-778-899',
    baptismStatus: true,
  ...
  m({
    ...
    emergencyContactRelationship: '母親',
    emergencyContactPhone: '0988-990-011',
    baptismStatus: false,
    status: 'Active',
    zoneId: 'zone-youth',
    groupId: 'group-joy',
  ...
  m({
    ...
    emergencyContactRelationship: '配偶',
    emergencyContactPhone: '0923-222-324',
    baptismStatus: true,
  ...
  m({
    ...
    emergencyContactRelationship: '父親',
    emergencyContactPhone: '0923-252-627',
    baptismStatus: true,
  ...
  m({
    ...
    emergencyContactName: '王太太',
    emergencyContactRelationship: '配偶',
    emergencyContactPhone: '0923-282-930',
    baptismStatus: true,
  ...
  m({
    ...
    emergencyContactRelationship: '配偶',
    emergencyContactPhone: '0923-313-233',
    baptismStatus: true,
  ...
  ...generateZoneMembers('zone-youth', [
    { group: 'group-joy', members: [
      { uuid: 'member-001', fullName: '趙恩慈', gender: 'Female' as const, dob: '1995-01-12', mobile: '0911-001-001', email: 'zhao.ec@example.com' },
      { uuid: 'member-002', fullName: '孫信實', gender: 'Male' as const, dob: '1993-06-22', mobile: '0911-001-002', email: 'sun.xs@example.com' },
  ...
  m({
    ...
    emergencyContactRelationship: '母親',
    emergencyContactPhone: '0922-006-001',
    status: 'Active',
  ...
  m({
    ...
    emergencyContactRelationship: '父親',
    emergencyContactPhone: '0922-006-002',
    status: 'Active',
  ...
  m({
    ...
    emergencyContactRelationship: '配偶',
    emergencyContactPhone: '0922-006-003',
    status: 'Active',
  ...
  m({
    ...
    emergencyContactRelationship: '配偶',
    emergencyContactPhone: '0922-007-001',
    status: 'Suspended',
    zoneId: 'zone-youth',
    groupId: 'group-joy',
    createdAt: '2024-03-01T08:00:00Z',
  ...
  m({
    ...
    emergencyContactRelationship: '父親',
    emergencyContactPhone: '0922-007-002',
    status: 'Inactive',
    zoneId: 'zone-family',
